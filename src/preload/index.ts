...
import type { CompanionApi, CompanionSettings, ControlState, UsageSnapshot } from "../shared/types";
...
const api: CompanionApi = {
  ...
  openTiboProfile: () => ipcRenderer.invoke("tibo:openProfile") as Promise<boolean>,
